...
import { Box, Button, Card, CardContent, CardMedia, IconButton, Rating, Stack, Typography, CardActionArea } from '@mui/material';
...
const CardDetailView = ({ categories, imageUrl, title, description, price, offerPrice, writtenBy, publisher, rating, reviews, year }) => (
    ...
    >
        ...
        <CardActionArea
            ...
            to={{
                pathname: '/detail',
                state: { data: categories, imageUrl, title, description, price, offerPrice, writtenBy, publisher, rating, reviews, year }
            }}
        >
